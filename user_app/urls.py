...
from user_app.views_bl import ProcessUserProfileData,ProcessChangePassword
urlpatterns = [
    # business logic urls
    path('user_profile_settings/',ProcessUserProfileData.as_view(),name="ProcessUserProfileData"),
    path('user_password_change_profile_page/',ProcessChangePassword.as_view(),name="ProcessChangePassword"),
